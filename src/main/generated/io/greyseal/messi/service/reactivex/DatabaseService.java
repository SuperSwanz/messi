...
package io.greyseal.messi.service.reactivex;
...
@io.vertx.lang.reactivex.RxGen(io.greyseal.messi.service.DatabaseService.class)
public class DatabaseService {
  ...
  public static final io.vertx.lang.reactivex.TypeArg<DatabaseService> __TYPE_ARG = new io.vertx.lang.reactivex.TypeArg<>(
    obj -> new DatabaseService((io.greyseal.messi.service.DatabaseService) obj),
    DatabaseService::getDelegate
  );

  private final io.greyseal.messi.service.DatabaseService delegate;
  
  public DatabaseService(io.greyseal.messi.service.DatabaseService delegate) {
    this.delegate = delegate;
  }

  public io.greyseal.messi.service.DatabaseService getDelegate() {
    return delegate;
  }
  ...
  public static  DatabaseService newInstance(io.greyseal.messi.service.DatabaseService arg) {
